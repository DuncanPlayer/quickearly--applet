...
Page({
  ...
  getCheckoutInfo: function () {
    ...
    util.request(api.ReservationCartCheckout, { addressId: that.data.addressId, couponId: that.data.couponId,userId: that.data.userInfo.id}).then(function (res) {
      if (res.status === 200) {
        that.setData({
  ...
  submitReservation: function () {
    ...
    var userInfo = app.getGlobalUserInfo();
    util.request(api.ReservationSubmit, {userId: userInfo.id,addressId: this.data.addressId, couponId: this.data.couponId, actualPrice: this.data.actualPrice, content: this.data.content, endTime: that.data.endTime}).then(res => {
      if (res.status === 200) {
